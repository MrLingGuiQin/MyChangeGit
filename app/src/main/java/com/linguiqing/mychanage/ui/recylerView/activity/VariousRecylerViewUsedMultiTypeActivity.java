...
import com.linguiqing.mychanage.ui.recylerView.provider.VariousModleOneViewProvider;
import com.linguiqing.mychanage.ui.recylerView.provider.VariousModleThreeViewProvider;
import com.linguiqing.mychanage.ui.recylerView.provider.VariousModleTwoViewProvider;
...
public class VariousRecylerViewUsedMultiTypeActivity extends BaseActivity {
...
//        mVariousRecyclerview.setLayoutManager(new LinearLayoutManager(mContext));
        ...
        gridLayoutManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
            ...
            public int getSpanSize(int position) {
                ...
                if (mItems.get(position) instanceof VariousRecylerViewModleThree) {
...
//        mVariousRecyclerview.addItemDecoration(new DividerItemDecoration(mContext, DividerItemDecoration.VERTICAL_LIST));
        ...
        mAdapter.register(VariousRecylerViewModleOne.class, new VariousModleOneViewProvider());
        mAdapter.register(VariousRecylerViewModleTwo.class, new VariousModleTwoViewProvider());
        mAdapter.register(VariousRecylerViewModleThree.class, new VariousModleThreeViewProvider());
